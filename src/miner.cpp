...
std::unique_ptr<CBlockTemplate> BlockAssembler::CreateNewBlock(const CScript& scriptPubKeyIn)
{
    ...
    pblock->nVersion = g_versionbitscache.ComputeBlockVersion(pindexPrev, CBlockHeader::AlgoType::ALGO_POW_SHA256, consensusParams);
    ...
    fIncludeWitness = DeploymentActiveAfter(pindexPrev, consensusParams, Consensus::DEPLOYMENT_SEGWIT);
