...
static void check_computeblockversion(const Consensus::Params& params, Consensus::DeploymentPos dep)
{
    ...
    BOOST_CHECK_EQUAL(g_versionbitscache.ComputeBlockVersion(nullptr, CBlockHeader::AlgoType::ALGO_POW_SHA256, params), VERSIONBITS_TOP_BITS);
    ...
    if (nTime == 0) {
        ...
        BOOST_CHECK_EQUAL(g_versionbitscache.ComputeBlockVersion(lastBlock, CBlockHeader::GetAlgoType(lastBlock->nVersion), params) & (1 << bit), 0);
        lastBlock = firstChain.Mine(params.nMinerConfirmationWindow, nTime, VERSIONBITS_LAST_OLD_BLOCK_VERSION).Tip();
        BOOST_CHECK((g_versionbitscache.ComputeBlockVersion(lastBlock, CBlockHeader::GetAlgoType(lastBlock->nVersion), params) & (1 << bit)) != 0);
    ...
    BOOST_CHECK_EQUAL(g_versionbitscache.ComputeBlockVersion(lastBlock, CBlockHeader::GetAlgoType(lastBlock->nVersion), params) & VERSIONBITS_TOP_MASK, VERSIONBITS_TOP_BITS);
