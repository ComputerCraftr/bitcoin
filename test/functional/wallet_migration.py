...
class WalletMigrationTest(BitcoinTestFramework):
    ...
    def test_loading_failure_after_migration(self):
        ...
        regtest_tip_time = self.old_node.getblockheader(self.old_node.getbestblockhash())["time"]
        self.stop_node(self.old_node.index)
        self.old_node.chain = "signet"
        # Do not apply the saved regtest tip time when starting the signet chain.
        self.old_node.chain_tip_time = None
        ...
        self.old_node.chain_tip_time = regtest_tip_time
